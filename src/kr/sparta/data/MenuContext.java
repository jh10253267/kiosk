...
public enum MenuContext {
    ...
    private void initializeData() {
        menuList = List.of(new Menu("BURGER", "앵거스 비프 통살을 다져만든 버거"),
                new Menu("ICE CREAM", "매장에서 신선하게 만드는 아이스크림"),
                new Menu("DRINKS", "매장에서 직접 만드는 음료"),
                new Menu("BEER", "뉴욕 브루클린 브루어리에서 양조한 맥주"));

        productList = List.of(new Product("ShackBurger", "토마토, 양상추, 쉑소스가 토핑된 치즈버거", 6.9, BURGER, List.of(new Option("Single", 6.9), new Option("Set", 8.0))),
                new Product("SmokeShack", "베이컨, 체리 페퍼에 쉑소스가 토핑된 치즈버거", 8.9, BURGER, List.of(new Option("Single", 8.9), new Option("Set", 10.0))),
                new Product("Shroom Burger", "몬스터 치즈와 체다 치즈로 속을 채운 베지테리안 버거", 9.4, BURGER, List.of(new Option("Single", 9.4), new Option("Set", 11.0))),
                new Product("Cheeseburger", "포테이토 번과 비프패티, 치즈가 토핑된 치즈버거", 6.9, BURGER, List.of(new Option("Single", 6.9), new Option("Set", 8.0))),
